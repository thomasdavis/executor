...
describe("toAiSdkTools", () => {
  it.effect("generates a tool call via generateText with a mock executor", () =>
    Effect.gen(function* () {
      ...
      const result = yield* Effect.tryPromise(() =>
        generateText({
          ...
          prompt: 'Run this code using the execute tool: console.log("hello")',
        }),
      );
  ...
  it.effect("calls a normal AI SDK tool from the execute sandbox", () =>
    Effect.gen(function* () {
  ...
  it.effect("executes code in a real Deno subprocess via generateText", () =>
    Effect.gen(function* () {
